...
namespace Richter.ExternalServices.Translator.Microsoft {
    ...
    public partial class GetTranslationsResponse : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private Richter.ExternalServices.Translator.Microsoft.TranslationMatch[] TranslationsField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute(EmitDefaultValue=false)]
        public Richter.ExternalServices.Translator.Microsoft.TranslationMatch[] Translations {
            get {
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://api.microsofttranslator.com/V2", ConfigurationName="Microsoft.LanguageService")]
    public interface LanguageService {
        ...
        Richter.ExternalServices.Translator.Microsoft.GetTranslationsResponse GetTranslations(string appId, string text, string from, string to, int maxTranslations, Richter.ExternalServices.Translator.Microsoft.TranslateOptions options);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/AddTranslationArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/AddTranslationArrayResponse" +
            "")]
        void AddTranslationArray(string appId, Richter.ExternalServices.Translator.Microsoft.Translation[] translations, string from, string to, Richter.ExternalServices.Translator.Microsoft.TranslateOptions options);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsArrayRespons" +
            "e")]
        Richter.ExternalServices.Translator.Microsoft.GetTranslationsResponse[] GetTranslationsArray(string appId, string[] texts, string from, string to, int maxTranslations, Richter.ExternalServices.Translator.Microsoft.TranslateOptions options);
        ...
        Richter.ExternalServices.Translator.Microsoft.TranslateArrayResponse[] TranslateArray(string appId, string[] texts, string from, string to, Richter.ExternalServices.Translator.Microsoft.TranslateOptions options);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface LanguageServiceChannel : Richter.ExternalServices.Translator.Microsoft.LanguageService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class LanguageServiceClient : System.ServiceModel.ClientBase<Richter.ExternalServices.Translator.Microsoft.LanguageService>, Richter.ExternalServices.Translator.Microsoft.LanguageService {
        ...
        public Richter.ExternalServices.Translator.Microsoft.GetTranslationsResponse GetTranslations(string appId, string text, string from, string to, int maxTranslations, Richter.ExternalServices.Translator.Microsoft.TranslateOptions options) {
        ...
        public void AddTranslationArray(string appId, Richter.ExternalServices.Translator.Microsoft.Translation[] translations, string from, string to, Richter.ExternalServices.Translator.Microsoft.TranslateOptions options) {
            base.Channel.AddTranslationArray(appId, translations, from, to, options);
        }
        
        public Richter.ExternalServices.Translator.Microsoft.GetTranslationsResponse[] GetTranslationsArray(string appId, string[] texts, string from, string to, int maxTranslations, Richter.ExternalServices.Translator.Microsoft.TranslateOptions options) {
        ...
        public Richter.ExternalServices.Translator.Microsoft.TranslateArrayResponse[] TranslateArray(string appId, string[] texts, string from, string to, Richter.ExternalServices.Translator.Microsoft.TranslateOptions options) {
